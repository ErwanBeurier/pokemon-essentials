...
def main_generate_sc_tiers(pokemon_list = None):
	...
	write_tier(pkmn_lists, [3, 0, 0, 0, 0], "Fully Evolved", "FE", stratum = 50, allow_specific = True)
	# write_tier(pkmn_lists, [3, 2, 1, 2, 2], "Fully Evolved, weighted", "FEW")
	write_tier(pkmn_lists, [3, 3, 0, 0, 0], "Fully Evolved w legendary", "FEL", stratum = 50, allow_specific = True)
	write_tier(pkmn_lists, [2, 3, 3, 0, 0], "Uber", "UBER", stratum = 50, allow_specific = True)
...
def main_generate_micro_tiers(pokemon_list = None):
	...
	# Only birds
	pkmn_frequent = ["PIDGEOT", "PIDGEOT_1", "PIDGEOT_2", "FEAROW", "FEAROW_1", "FARFETCHD", "DODRIO", "ARTICUNO", "ZAPDOS", "MOLTRES", "NOCTOWL", "XATU", "DELIBIRD", "SKARMORY", "BLAZIKEN", "SWELLOW", "EMPOLEON", "STARAPTOR", "HONCHKROW", "CHATOT", "TOGEKISS", "UNFEZANT", "ARCHEOPS", "SWANNA", "BRAVIARY", "MANDIBUZZ", "TALONFLAME", "HAWLUCHA", "DECIDUEYE", "TOUCANNON", "ORICORIO", "FEAROW_1", "NOCTOWL_1", "ARCHEOPS_1", "BRAVIARY_1", "CORVIKNIGHT", "CRAMORANT", "SIRFETCHD", "EISCUE"]
	pkmn_rare = []
	...
	pkmn_rare = []
	pkmn_frequent = ["PERSIAN", "VAPOREON", "JOLTEON", "FLAREON", "ESPEON", "UMBREON", "RAIKOU", "ENTEI", "SUICUNE", "DELCATTY", "ZANGOOSE", "ABSOL", "LUXRAY", "PURUGLY", "LEAFEON", "GLACEON", "LIEPARD", "PYROAR", "MEOWSTIC", "INCINEROAR", "PERSIAN_1", "DELCATTY_1", "LIEPARD_1", "PERRSERKER"]
	write_micro_tiers([pkmn_frequent, pkmn_rare, pkmn_allowed], POKEMONS, "Cats and other felids", "CATS")
	
	
	# Only dogs 
	pkmn_frequent = ["NINETALES", "NINETALES_1", "NINETALES_2", "ARCANINE", "GRANBULL", "HOUNDOOM", "MIGHTYENA", "MANECTRIC", "LUCARIO", "STOUTLAND", "ZOROARK", "DELPHOX", "FURFROU", "LYCANROC", "SILVALLY", "NINETALES_3", "GRANBULL_1", "THIEVUL", "BOLTUND"]
	pkmn_rare = []
	pkmn_allowed = ["VULPIX", "GROWLITHE", "SNUBBULL", "HOUNDOUR", "POOCHYENA", "ELECTRIKE", "RIOLU", "LILLIPUP", "HERDIER", "ZORUA", "FENNEKIN", "BRAIXEN", "ROCKRUFF", "TYPENULL", "VULPIX_1", "SNUBBULL_1", "NICKIT", "YAMPER"]
	...
	write_micro_tiers([pkmn_frequent, pkmn_rare, pkmn_allowed], POKEMONS, "Turtles and crocodiles", "TURTLES")
	...
	# Deep sea 
	pkmn_frequent = ["LANTURN", "QWILFISH", "CORSOLA", "KINGDRA", "HUNTAIL", "GOREBYSS", "RELICANTH", "LUMINEON", "PHIONE", "MANAPHY", "EELEKTROSS", "BARBARACLE", "DRAGALGE", "PYUKUMUKU", "DHELMISE", "KINGDRA_1", "CURSOLA", "ARCTOVISH", "DRACOVISH"]
	...
	# Antic 
	pkmn_frequent = [pk for pk in POKEMONS if POKEMONS[pk].evolution_stage == POKEMONS[pk].evolution_stage_max and POKEMONS[pk].canLearnMove("ANCIENTPOWER")]
	pkmn_rare = []
	pkmn_allowed = [pk for pk in POKEMONS if POKEMONS[pk].evolution_stage < POKEMONS[pk].evolution_stage_max and POKEMONS[pk].canLearnMove("ANCIENTPOWER")]
	...
	# European Forest 
	pkmn_frequent = ["NINETALES", "VENOMOTH", "FURRET", "LEDIAN", "ARIADOS", "ARIADOS_1", "FORRETRESS", "URSARING", "STANTLER", "MIGHTYENA", "LINOONE", "SHIFTRY", "SWELLOW", "BRELOOM", "ZANGOOSE", "WORMADAM", "MOTHIM", "VESPIQUEN", "PACHIRISU", "FLOATZEL", "LOPUNNY", "HONCHKROW", "SKUNTANK", "SHAYMIN", "EMBOAR", "UNFEZANT", "LEAVANNY", "SAWSBUCK", "AMOONGUSS", "FERROTHORN", "DURANT", "DELPHOX", "DIGGERSBY", "TALONFLAME", "LURANTIS", "SHIINOTIC", "NINETALES_1", "NINETALES_2", "LEDIAN_1", "ARIADOS_1", "JUMPLUFF_1", "JUMPLUFF", "GREEDENT", "CORVIKNIGHT", "ORBEETLE", "OBSTAGOON"]
...
def main_generate_random_tiers(pokemon_list = None):
	...
	ignored_pokemons = ["WISHIWASHI", "WISHIWASHI_1", "SLAKING", "ARCHEOPS"] + pku.get_legendary(POKEMONS) + pku.get_strong_legendary(POKEMONS)
