...
# 
# This script is an adaptation of the SOS Battles script by Vendily. 
# SOS Battles are not implemented in the Project STRAT. This script is adapted 
# to allow for the insertion of "invasive" abilities, that summon a clone 
...
class PokeBattle_Battle
  ...
  def pbCallForHelp(caller)
    return if pbSideSize(caller.index) == 6 
