...
class PokemonOption_Scene
  ...
  def pbStartScene(inloadscreen=false)
    ...
    @PokemonOptions = [
       ...
       EnumOption.new(_INTL("Control team gen."),[_INTL("On"),_INTL("Off")],
         proc { SCVar.get(:AskStrataForTeamGeneration) },
         proc { |value| SCVar.set(:AskStrataForTeamGeneration, value) }
       ),
