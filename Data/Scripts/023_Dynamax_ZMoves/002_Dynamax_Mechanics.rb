...
CAN_DMAX_WILD  = false # Allows Dynamaxing in normal wild battles when true.
...
#===============================================================================
# Moves that function based on the target's non-Dynamax HP.
#===============================================================================
# Pain Split
#-------------------------------------------------------------------------------
...
class PokeBattle_Move_049 < PokeBattle_TargetStatDownMove
  ...
  def pbFailsAgainstTarget?(user,target)
    ...
    dynamax_pbFailsAgainstTarget?(user,target)
    return super
  end
...
#===============================================================================
# Moves that fail when used in a Max Raid battle.
#===============================================================================
# Self-Destruct/Explosion (only fails when used by Raid Boss)
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Destiny Bond (only fails when used by Raid Boss)
#-------------------------------------------------------------------------------
